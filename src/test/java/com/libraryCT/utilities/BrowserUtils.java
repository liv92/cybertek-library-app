...
public class BrowserUtils {
    ...
    /**
     * Finds broken links in any given website and prints them.
     * @param webPage
     * @return List<WebElement>
     */
    public static List<WebElement> findBrokenLinks(String webPage){
        ...
        for (WebElement each : links) {
            ...
            if (url == null || url.isEmpty()) {
                System.err.println(url + " is not configured or anchor tag is empty");
                continue;
            }
        ...
        System.err.println("Count of broken links = " + brokenLinks.size());
    ...
    public static boolean waitForTitle(String title, int timeToWaitInSec) {
